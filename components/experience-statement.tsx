...
function ImageSeal({ id }: { id: string }) {
  ...
  return <svg className={styles.seal} viewBox="0 0 126 126" aria-hidden="true" focusable="false">
    ...
    <text className={styles.sealMark} x="63" y="74" textAnchor="middle">jd.</text>
  </svg>;
}
  ...
  return <section ref={root} className={styles.root} aria-labelledby="experience-statement-title">
    ...
    <figure className={styles.photo} data-experience-motion="photo">
      <Image
        ...
        alt="Detalhe de lentes e estética do sorriso realizado pela Dra. Jaqueline Dantas."
        fill
        sizes="(max-width: 700px) 94vw, (max-width: 1100px) 50vw, 45vw"
      />
      <span className={styles.photoWash} aria-hidden="true" />
      <p className={styles.photoCopy} data-experience-motion="photo-copy">SEU SORRISO.<br />SUA HISTÓRIA.<br />SUA ESSÊNCIA.<span aria-hidden="true" /></p>
      <ImageSeal id={uid} />
    </figure>
    ...
    <blockquote className={styles.quote} data-experience-motion="quote">
      ...
      <div>
        <p>Naturalidade é<br />beleza com identidade.</p>
        <footer><span aria-hidden="true" /><cite>JAQUELINE DANTAS</cite></footer>
      </div>
    </blockquote>
