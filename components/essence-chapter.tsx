...
const pillars = [
  { title: 'Identidade', copy: 'Seu sorriso. Sua história. O nosso ponto de partida.', Icon: UserRound },
  { title: 'Naturalidade', copy: 'Escolhas que valorizam a sua expressão, sem excessos.', Icon: Leaf },
  { title: 'Preservação', copy: 'Um método conservador, guiado pela avaliação do seu sorriso.', Icon: Heart },
];
  ...
  return <section id="manifesto" className="essence-editorial" ref={root} aria-labelledby="essence-title">
    <div className="essence-stage">
      ...
      <div className="essence-editorial-copy">
        ...
        <p className="essence-editorial-description" data-essence-motion="fade" data-delay="350">Cuidar do sorriso é olhar para você: sua expressão, seus desejos e tudo o que torna a sua beleza única.</p>
      ...
      <figure className="essence-smile" data-essence-motion="photo">
        <Image src={site.images.essence} alt="Dra. Jaqueline Dantas em seu consultório odontológico." fill loading="eager" sizes="(max-width:700px) 112vw, (max-width:1100px) 82vw, 67vw"/>
      </figure>
